...
const Categories = () => (
  <>
    <ProductsList games={promocoes} titulo="RPG" fundo="cinza" />
    <ProductsList games={emBreve} titulo="Ação" fundo="preto" />
    <ProductsList games={promocoes} titulo="Plataforma" fundo="cinza" />
    <ProductsList games={emBreve} titulo="Roguelike" fundo="preto" />
  </>
)
